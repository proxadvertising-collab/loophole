...
const BrowseLoader: React.FC = () => (
  <div className="flex items-center justify-center min-h-[60vh]">
    <div className="bg-white rounded-xl shadow-md p-10 flex flex-col items-center w-full max-w-xl">
      <div className="mb-6">
        <svg className="h-12 w-12 animate-spin text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="#000000" d="M4 12a8 8 0 018-8v8z"></path></svg>
      </div>
