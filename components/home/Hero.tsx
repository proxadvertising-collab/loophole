    ...
    <section className="px-4 pb-8 pt-10 md:px-6 md:pt-14">
      <div className="mx-auto max-w-6xl rounded-3xl border border-gray-200 bg-white p-6 shadow-sm md:p-10">
        ...
        <p className="mt-5 max-w-3xl text-lg text-gray-600 md:text-2xl md:leading-[1.4]">
          Off-market subto, seller finance, wrap, novation, wholesale, foreclosure, and cash. Financing is the listing.
        </p>
        ...
        <div className="mt-7 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm font-medium text-gray-700 md:text-base">
          <span className="inline-flex items-center gap-2">
            ...
            Nationwide investors, buyers, sellers
          </span>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-2 text-sm">
          ...
          <Link href="/browse?category=Subto" className="rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-gray-700 hover:border-black/40 hover:text-black">
            Subto
          </Link>
          <Link href="/browse?category=Seller Finance" className="rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-gray-700 hover:border-black/40 hover:text-black">
            Seller Finance
          </Link>
          <Link href="/browse?category=Wholesale" className="rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-gray-700 hover:border-black/40 hover:text-black">
            Wholesale
          </Link>
        </div>
      </div>
